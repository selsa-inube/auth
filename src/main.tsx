...
const TIMEOUT = import.meta.env.VITE_SIGNOUT_TIME;
const SIGNOUT_REDIRECT_URL = import.meta.env.VITE_SIGNOUT_REDIRECT_URL;
const WITH_SIGNOUT_MOUSE_MOVE = import.meta.env.VITE_RESET_SIGNOUT_MOUSE_MOVE;
const WITH_SIGNOUT_KEY_DOWN = import.meta.env.VITE_RESET_SIGNOUT_KEY_DOWN;
const WITH_SIGNOUT_MOUSE_DOWN = import.meta.env.VITE_RESET_SIGNOUT_MOUSE_DOWN;
const WITH_SIGNOUT_SCROLL = import.meta.env.VITE_RESET_SIGNOUT_SCROLL;
const WITH_SIGNOUT_TOUCHSTART = import.meta.env.VITE_RESET_SIGNOUT_TOUCHSTART;
const WITH_SIGNOUT_CHANGE_PAGE = import.meta.env.VITE_RESET_SIGNOUT_CHANGE_PAGE;
...
ReactDOM.createRoot(document.getElementById("root")!).render(
  <AuthProvider
    ...
    resetSignOutChangePage={WITH_SIGNOUT_CHANGE_PAGE}
  >
    <App />
  </AuthProvider>
);
